...
egg_size_2 <- egg_size %>% 
mutate( fly_line = recode(fly_line, A1 = "1",
                          A2 = "2",
                          A3 = "3",
                          S1 = "1",
                          S2 = "2",
...
egg_ls2 <- lm(egg_volume ~ selection_diet*fly_line, data = egg_size_2)

egg_ls3 <- lm(egg_volume ~ selection_diet/fly_line, data = egg_size_2)
