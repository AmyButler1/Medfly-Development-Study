...
egg_size2 <- read_excel("data/pilot_data/pilot_egg_size.xlsx")
# view(egg_size)
# skim(egg_size)
head(egg_size2)
...
egg_plots2(data = egg_size2, egg_measure = "egg_length", line = "fly_line")
egg_plots2(data = egg_size2, egg_measure = "egg_width", line = "fly_line")
...
egg_ls1 <- lm(egg_volume ~ selection_diet, data = egg_size2)
summary(egg_ls1)

egg_ls2 <- lm(egg_volume ~ selection_diet*fly_line, data = egg_size2)
summary(egg_ls2)

egg_ls3 <- lm(egg_volume ~ selection_diet/fly_line, data = egg_size2)
summary(egg_ls3)
plot(egg_ls3)